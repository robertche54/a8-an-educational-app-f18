    ...
    ui(new Ui::MeteorSlide2)
{
    ...
    ui->backLabel->setPixmap(QPixmap("../a8-an-educational-app-f18-LandonRoundy/dinoscene0.jpg"));
...
void MeteorSlide2::changeBackground(){
    switch(++backgroundIndex){
        case 1:
            ui->backLabel->setPixmap(QPixmap("../a8-an-educational-app-f18-LandonRoundy/dinoscene1.jpg"));
            break;
        case 2:
            ui->backLabel->setPixmap(QPixmap("../a8-an-educational-app-f18-LandonRoundy/dinoscene2.jpg"));
            break;
        case 3:
            ui->backLabel->setPixmap(QPixmap("../a8-an-educational-app-f18-LandonRoundy/dinoscene3.jpg"));
            break;
        case 4:
            ui->backLabel->setPixmap(QPixmap("../a8-an-educational-app-f18-LandonRoundy/dinoscene4.jpg"));
            break;
        default:
            backGroundTimer->stop();
            sim->createMob("../a8-an-educational-app-f18-LandonRoundy/landDinos/smoke.png",0,25,40,10,"smoke",b2_dynamicBody);
            break;
    }
}
...
void MeteorSlide2::on_startButton_clicked(){
    ...
    // Add meteor mob
    sim->createMob("../a8-an-educational-app-f18-LandonRoundy/meteorite.png",22,100,30,30,"meteor", b2_dynamicBody);
    Mob* meteor = sim->namedMobs.at("meteor");
    sim->applyImpulse(meteor,265,300);

    for(uint i=0; i<128; i++){
        sim->createMob("../a8-an-educational-app-f18-LandonRoundy/Lava.png", i-64, -11, 1, 1,b2_dynamicBody);
    }
...
{
    dinos.insert(pair<string,Mob*>("TRex",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/TRex.png",-3,-5,3,3,sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("dino2",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/dino2.png",-10,-2,2,2,sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("pteranodon",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/pteranodon.png",1, 6, 4, 4,sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("rock",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/rock.png",0,-8,4,4, sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("screamingDino",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/screamingDino.png", -6, -6, 6, 6, sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("spikey",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/spikey.png", -3,-2,2,1, sim->world)));
...
{
    dinos.insert(pair<string,Mob*>("tree",new Mob("../a8-an-educational-app-f18-LandonRoundy/landDinos/tree.png",9,-5,8,8,sim->world)));
