...
void MeteorSlide2::on_TRexButton_clicked()
{
    if(TRexActive){
        ...
        dinos.insert(pair<string,Mob*>("TRex",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/TRex.png",-3,-5,2,2,sim->world)));
...
void MeteorSlide2::on_dino2Button_clicked()
{
    if(dino2Active){
        ...
        dinos.insert(pair<string,Mob*>("dino2",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/dino2.png",-8,-2,2,2,sim->world)));
...
void MeteorSlide2::on_pteranButton_clicked()
{
    if(pterActive){
       ...
       dinos.insert(pair<string,Mob*>("pteranodon",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/pteranodon.png",2, 6, 2, 2,sim->world)));
...
void MeteorSlide2::on_rockButton_clicked()
{
    if(rockActive){
        ...
        dinos.insert(pair<string,Mob*>("rock",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/rock.png",2,-9,4,4, sim->world)));
...
void MeteorSlide2::on_screamingDino_clicked()
{
    if(screamingDinoActive){
        ...
        dinos.insert(pair<string,Mob*>("screamingDino",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/screamingDino.png", -8, -4, 3, 3, sim->world)));
...
void MeteorSlide2::on_spikeyButton_clicked()
{
    if(spikeyActive){
        ...
        dinos.insert(pair<string,Mob*>("spikey",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/spikey.png", -4,-2,2,1, sim->world)));
...
void MeteorSlide2::on_treeButton_clicked()
{
    if(treeActive){
        ...
        dinos.insert(pair<string,Mob*>("tree",new Mob("/home/spencer/CS3505/A9/a8-an-educational-app-f18-LandonRoundy/landDinos/tree.png",8,-8,10,10,sim->world)));
